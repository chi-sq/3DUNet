...
def applicator(args):
    ...
    load_checkpoint(config.CHECKPOINT, model, opt_gen, config.LEARNING_RATE)
    ...
    ## Resize
    segData = resize_volume(segData[0, :, :, :], desired_depth=z_original, desired_width=x_original,
                            desired_height=y_original)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default=config.CHECKPOINT)

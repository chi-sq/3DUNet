...
class UNet3D(nn.Module):
    def __init__(self, in_channel, n_classes):
        ...
        self.ec1 = self.encoder(32, 64, bias=False)
        self.ec2 = self.encoder(64, 64, bias=False)
        self.ec3 = self.encoder(64, 128, bias=False)
        self.ec4 = self.encoder(128, 128, bias=False)
        self.ec5 = self.encoder(128, 256, bias=False)
        self.ec6 = self.encoder(256, 256, bias=False)
        self.ec7 = self.encoder(256, 512, bias=False)
...
class UNet3D_BN(nn.Module):
    ...
    def __init__(self, in_channel, n_classes, use_batch_norm=True):
        ...
        self.ec0 = self.encoder(self.in_channel, 32, bias=False,)
        self.ec1 = self.encoder(32, 64, bias=False)
        self.ec2 = self.encoder(64, 64, bias=False)
        self.ec3 = self.encoder(64, 128, bias=False)
        self.ec4 = self.encoder(128, 128, bias=False)
